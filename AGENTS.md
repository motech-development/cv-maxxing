...
- Commit team-owned Codex workspace configuration under `.codex/` when it defines shared workspace actions the team should use; avoid treating unrelated personal local Codex state as project source.
