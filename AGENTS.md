...
- Do not add tests whose only purpose is to prove that old code, old copy, or old references were removed. Test active behavior and durable contracts instead.
